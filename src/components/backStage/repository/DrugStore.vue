<template>
  <div>
    ...
    <el-button class="normal_button" @click="registerDrug">注 册</el-button>
  </span>
    </el-dialog>
    ...
    <el-button class="normal_button" @click="modifyDrug">保 存</el-button>
  </span>
    </el-dialog>
